...
## Submódulo de Estoque de TI
- [x] Criar tabelas no banco de dados (stockItems, stockMovements, stockRequests)
- [x] Implementar funções de banco de dados para estoque
- [x] Criar routers tRPC para gestão de estoque (admin)
- [x] Criar routers tRPC para solicitações de estoque (usuário)
- [x] Criar página de gestão de estoque para administradores (CRUD completo)
- [x] Criar página de catálogo de estoque para usuários (visualização + solicitação)
- [x] Implementar integração automática com sistema de chamados ao solicitar item
- [x] Adicionar controle de permissões (admin vs usuário)
- [x] Sincronizar com sistema de permissões de grupos
- [x] Adicionar navegação no módulo de Chamados para acessar Estoque
